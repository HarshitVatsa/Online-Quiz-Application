...
public class RegisterStudentFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("E:\\javadocx\\TECH-QUIZ-APP\\TECH QUIZ APP\\onlineexam\\Student-Registration-Icon.png")); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(btnBack, javax.swing.GroupLayout.DEFAULT_SIZE, 144, Short.MAX_VALUE))))
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        if(isValidInput==0){
            JOptionPane.showMessageDialog(null,"Username and Password cann't be left blank!","Error!",JOptionPane.ERROR_MESSAGE);
            return;
        }
        if(isValidInput==-1){
            JOptionPane.showMessageDialog(null,"Username and Password should have atleast 4 characters!","Information!",JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        if(isValidInput==-2){
            JOptionPane.showMessageDialog(null,"Password and Re-type password doesn't match!","Error!",JOptionPane.ERROR_MESSAGE);
            return;
        }
        if(isValidInput==1)
        {
            ...
            try{
                ...
                boolean userDetail=UserDao.addUser(obj);
                if(userDetail){
                    JOptionPane.showMessageDialog(null,"Registration successfully done!","Information!",JOptionPane.INFORMATION_MESSAGE);
                    clearAll();
                }
                else
                    JOptionPane.showMessageDialog(null,"Record already present!","Information!",JOptionPane.INFORMATION_MESSAGE);
            }
...
private int validateInputs()
        {
            ...
            else if(userid.length()<4||pwd.length<4)
            {
                return -1;
            }
