...
public class QuestionPojo {
    ...
    public String toString() {
        return "QuestionPojo{" + "examId=" + examId + ", qno=" + qno + ", language=" + language + ", answer1=" + answer1 + ", answer2=" + answer2 + ", answer3=" + answer3 + ", answer4=" + answer4 + ", correctAnswer=" + correctAnswer + ", qustion=" + question + '}';
    }
